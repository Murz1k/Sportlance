...
namespace Sportlance.DAL.Core
{
    public sealed class AppDBContext : DbContext, IReadOnlyDataContext, IEditableDataContext
    {
        ...
        IQueryable<MediaTypeNames.Application> IReadOnlyDataContext.Applications => Applications.AsNoTracking();
        ...
        public DbSet<MediaTypeNames.Application> Applications { get; set; }
