...
namespace Sportlance.WebAPI.Options
{
    public class JwtIssuerOptions
    {
        ...
        /// Set the timespan the token will be valid for (default is 5 min/300 seconds)
        /// </summary>
        public TimeSpan AccessTokenRefreshInterval { get; set; }

        /// <summary>
        /// "exp" (Expiration Time) Claim (returns IssuedAt + AccessTokenExpiration)
        /// </summary>
        ...
        public DateTime Expiration => IssuedAt.AddMinutes(AccessTokenExpiration.TotalMinutes);
