...
namespace Sportlance.WebAPI.Migrations
{
    ...
    [Migration("20190227083725_RenameFeedbacksToTrainerFeedback")]
    partial class RenameFeedbacksToTrainerFeedback
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sportlance.WebAPI.Entities.TrainerFeedback", b =>
                {
            ...
            modelBuilder.Entity("Sportlance.WebAPI.Entities.TrainerWorkExperience", b =>
                {
                    ...
                    b.ToTable("TrainerWorkExperience");
                });

            modelBuilder.Entity("Sportlance.WebAPI.Entities.TrainerWorkExperienceSport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<long>("TrainerWorkExperienceId");

                    b.HasKey("Id");

                    b.HasIndex("SportId");

                    b.HasIndex("TrainerWorkExperienceId");

                    b.ToTable("TrainerWorkExperienceSport");
                });
            ...
            modelBuilder.Entity("Sportlance.WebAPI.Entities.TrainerFeedback", b =>
                {
                    b.HasOne("Sportlance.WebAPI.Entities.Training")
                        .WithOne("Feedback")
                        .HasForeignKey("Sportlance.WebAPI.Entities.TrainerFeedback", "TrainingId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Sportlance.WebAPI.Entities.TrainerWorkExperienceSport", b =>
                {
                    ...
                    b.HasOne("Sportlance.WebAPI.Entities.TrainerWorkExperience", "TrainerWorkExperience")
                        .WithMany("Skills")
                        .HasForeignKey("TrainerWorkExperienceId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
