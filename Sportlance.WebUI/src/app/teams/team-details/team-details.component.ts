...
export class TeamDetailsComponent implements OnInit {
  ...
  changePhoto() {
    this.dialog.open(EditTeamPhotoDialogComponent, {data: <EditTeamPhotoDialogData>{url: this.team.photoUrl, team: this.team}})
      .afterClosed()
      .subscribe((result) => {
        if (result) {
  ...
  changeBackground() {
    this.dialog.open(EditTeamBackgroundDialogComponent, {data: <EditTeamBackgroundDialogData>{url: this.team.backgroundUrl, team: this.team}})
      .afterClosed()
      .subscribe((result) => {
        if (result) {
          Object.assign(this.team, result);
